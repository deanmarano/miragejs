(function (global, factory) {
  ...
  var navigator = globalThis$s.navigator;
  ...
  var ordinaryToPrimitive$1 = function (input, pref) {
    var fn, val;
    if (pref === 'string' && isCallable$j(fn = input.toString) && !isObject$t(val = call$h(fn, input))) return val;
    if (isCallable$j(fn = input.valueOf) && !isObject$t(val = call$h(fn, input))) return val;
    if (pref !== 'string' && isCallable$j(fn = input.toString) && !isObject$t(val = call$h(fn, input))) return val;
  ...
  var defineGlobalProperty$3 = function (key, value) {
    try {
      defineProperty$a(globalThis$p, key, { value: value, configurable: true, writable: true });
    } catch (error) {
  ...
  var hasOwnProperty$h = uncurryThis$s({}.hasOwnProperty);
  ...
  var toString$f = uncurryThis$r(1.1.toString);
  ...
  var Symbol$8 = globalThis$n.Symbol;
  ...
  var ie8DomDefine = !DESCRIPTORS$k && !fails$u(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  var v8PrototypeDefineBug = DESCRIPTORS$i && fails$t(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  var WeakMap$3 = globalThis$l.WeakMap;
  ...
  var WeakMap$2 = globalThis$k.WeakMap;
  ...
  var getterFor = function (TYPE) {
    return function (it) {
      var state;
      if (!isObject$p(it) || (state = get$4(it)).type !== TYPE) {
  ...
  var CONFIGURABLE_LENGTH = DESCRIPTORS$e && !fails$s(function () {
  ...
  var makeBuiltIn$2 = makeBuiltIn$3.exports = function (value, name, options) {
    ...
    if (!hasOwn$8(value, 'name') || (CONFIGURABLE_FUNCTION_NAME$2 && value.name !== name)) {
      if (DESCRIPTORS$e) defineProperty$9(value, 'name', { value: name, configurable: true });
    ...
    try {
      if (options && hasOwn$8(options, 'constructor') && options.constructor) {
        if (DESCRIPTORS$e) defineProperty$9(value, 'prototype', { writable: false });
  ...
  var objectKeysInternal = function (object, names) {
    ...
    var result = [];
    var key;
    for (key in O) !hasOwn$7(hiddenKeys$3, key) && hasOwn$7(O, key) && push$5(result, key);
  ...
  */
  ...
  var NEW_ITERATOR_PROTOTYPE = !isObject$n(IteratorPrototype$2) || fails$n(function () {
    var test = {};
  ...
  // V8 ~ Chrome 45- bug
  if (DESCRIPTORS$c && values$2.name !== 'values') try {
    defineProperty$6(values$2, 'name', { value: 'values' });
  } catch (error) { /* empty */ }
  ...
  $$q({ target: 'Object', stat: true, arity: 2, forced: Object.assign !== assign$2 }, {
    assign: assign$2
  });
  ...
  var propertyIsEnumerable$2 = uncurryThis$g($propertyIsEnumerable);
  var push$3 = uncurryThis$g([].push);

  // in some IE versions, `propertyIsEnumerable` returns incorrect result on integer keys
  // of `null` prototype objects
  var IE_BUG = DESCRIPTORS$a && fails$l(function () {
    // eslint-disable-next-line es/no-object-create -- safe
  ...
  var createMethod$2 = function (TO_ENTRIES) {
    return function (it) {
      ...
      while (length > i) {
        key = keys[i++];
        if (!DESCRIPTORS$a || (IE_WORKAROUND ? key in O : propertyIsEnumerable$2(O, key))) {
  ...
  var FAILS_ON_PRIMITIVES$1 = fails$k(function () { nativeKeys$2(1); });
  ...
  if (!TO_STRING_TAG_SUPPORT) {
    defineBuiltIn$7(Object.prototype, 'toString', toString$e, { unsafe: true });
  }
  ...
  */
  function referenceSort (edges) {
    ...
    var visited = {};
    var i = cursor;
    var _visit = function visit(node, i, predecessors) {
      ...
      if (i) {
        ...
        do {
          ...
          var child = pair[1];
          if (child) {
            _visit(child, nodes.indexOf(child), preds);
          }
        } while (i);
      }
      sorted[--cursor] = node;
  ...
  var _Factory = function Factory() {
    this.build = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(sequence) {
        var _this = this;
        var object, topLevelAttrs, keys, _iterator, _step, _loop, _t3;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              object = {};
              topLevelAttrs = Object.assign({}, this.attrs);
              delete topLevelAttrs.afterCreate;
              Object.keys(topLevelAttrs).forEach(function (attr) {
                if (_Factory.isTrait.call(_this, attr)) {
                  delete topLevelAttrs[attr];
                }
              });
              keys = sortAttrs(topLevelAttrs, sequence);
              _iterator = _createForOfIteratorHelper(keys);
              _context4.p = 1;
              _loop = /*#__PURE__*/_regenerator().m(function _loop() {
                var key, buildAttrs, _buildSingleValue, value;
                return _regenerator().w(function (_context3) {
                  while (1) switch (_context3.n) {
                    case 0:
                      key = _step.value;
                      buildAttrs = /*#__PURE__*/function () {
                        var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(attrs) {
                          var result, _i, _Object$entries, _Object$entries$_i, k, v;
                          return _regenerator().w(function (_context) {
                            while (1) switch (_context.n) {
                              case 0:
                                result = {};
                                _i = 0, _Object$entries = Object.entries(attrs);
                              case 1:
                      ...
                      _buildSingleValue = /*#__PURE__*/function () {
                        var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(value) {
                          var result, _iterator2, _step2, item, _t, _t2;
                      ...
                      value = topLevelAttrs[key];
                      if (!isFunction$3(value)) {
                        _context3.n = 2;
                        break;
                      }
                      _context3.n = 1;
                      return value.call(object, sequence);
                    case 1:
                      object[key] = _context3.v;
                      _context3.n = 4;
                      break;
                    case 2:
                      _context3.n = 3;
                      return _buildSingleValue(value);
                    case 3:
                      object[key] = _context3.v;
                    case 4:
  ...
  _Factory.extend = function (attrs) {
    ...
    // Copy extend
    Subclass.extend = _Factory.extend;
    Subclass.extractAfterCreateCallbacks = _Factory.extractAfterCreateCallbacks;
    Subclass.isTrait = _Factory.isTrait;

    // Store a reference on the class for future subclasses
    Subclass.attrs = newAttrs;
    return Subclass;
  };
  _Factory.extractAfterCreateCallbacks = function () {
    var _this2 = this;
  ...
  _Factory.isTrait = function (attrName) {
    var attrs = this.attrs;
  ...
  var FLAGS_GETTER_IS_CORRECT = !fails$h(function () {
  ...
  */
  ...
  var RangeError$1 = globalThis$f.RangeError;
  ...
  $$k({ global: true, constructor: true, forced: NativeArrayBuffer !== ArrayBuffer$1 }, {
  ...
  $$j({ target: 'String', stat: true, arity: 1, forced: INCORRECT_LENGTH }, {
    // eslint-disable-next-line no-unused-vars -- required for `.length`
    fromCodePoint: function fromCodePoint(x) {
      ...
      while (length > i) {
        code = +arguments[i++];
        if (toAbsoluteIndex$2(code, 0x10FFFF) !== code) throw new $RangeError(code + ' is not a valid code point');
  ...
  var safeGetBuiltIn$2 = function (name) {
    if (!DESCRIPTORS$6) return globalThis$d[name];
      ...
      if (query) {
        ...
        while (index < attributes.length) {
          ...
          if (attribute.length) {
            ...
            push$2(entries, {
              key: decode$2(shift(entry)),
              value: decode$2(join(entry, '='))
            });
          }
        }
      }
  ...
  */
  ...
  UNSUPPORTED_Y$1 || fails$d(function () {
  ...
  var fixRegexpWellKnownSymbolLogic = function (KEY, exec, FORCED, SHAM) {
    ...
    var DELEGATES_TO_EXEC = DELEGATES_TO_SYMBOL && !fails$a(function () {
      ...
      if (KEY === 'split') {
        ...
        var constructor = {};
        // eslint-disable-next-line unicorn/no-immediate-mutation -- ES3 syntax limitation
        constructor[SPECIES$3] = function () { return re; };
  ...
  fixRegExpWellKnownSymbolLogic('replace', function (_, nativeReplace, maybeCallNative) {
    ...
    return [
      ...
      function replace(searchValue, replaceValue) {
        ...
        var replacer = isObject$d(searchValue) ? getMethod$1(searchValue, REPLACE) : undefined;
        return replacer
      ...
      function (string, replaceValue) {
        ...
        var flags = toString$5(getRegExpFlags(rx));
  ...
  */
  ...
  var speciesConstructor$1 = function (O, defaultConstructor) {
    ...
    var S;
    return C === undefined || isNullOrUndefined$2(S = anObject$3(C)[SPECIES$2]) ? defaultConstructor : aConstructor(S);
  };
  ...
  var set$1 = globalThis$6.setImmediate;
  ...
  if (!set$1 || !clear) {
    ...
    // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
      ...
      isCallable$4(globalThis$6.postMessage) &&
  ...
  var isThenable = function (it) {
    var then;
    return isObject$c(it) && isCallable$2(then = it.then) ? then : false;
  };
   ...
   */
  function maybeAsync(isAsync, value) {
  ...
  var DbCollection = /*#__PURE__*/function () {
    function DbCollection(name, initialData, IdentityManager) {
      ...
      this.name = name;
      this._records = [];
      this._async = false; // Will be set by Db
    ...
    return _createClass(DbCollection, [{
      key: "all",
      value: function all() {
        return maybeAsync(this._async, duplicate(this._records));
      }
      ...
      value: function insert(data) {
        var _this = this;
        if (!Array.isArray(data)) {
          return maybeAsync(this._async, this._insertRecord(data));
        } else {
          var result = map$2(data, function (attrs) {
            return _this._insertRecord(attrs);
          });
          return maybeAsync(this._async, result);
        }
      }
      ...
      value: function find(ids) {
        if (Array.isArray(ids)) {
          ...
          return maybeAsync(this._async, records);
        } else {
          var record = this._findRecord(ids);
          if (!record) {
            return maybeAsync(this._async, null);
          }

          // Return a copy
          return maybeAsync(this._async, duplicate(record));
        }
      }
      ...
      value: function where(query) {
        ...
        if (records && typeof records.then === 'function') {
          return records.then(function (r) {
            return maybeAsync(_this2._async, r.map(duplicate));
          });
        }
      ...
      value: function firstOrCreate(query) {
        ...
        if (this._async) {
          return this.where(query).then(function (queryResult) {
            ...
            if (record) {
              ...
              return _this3.insert(mergedAttributes);
            }
          });
        } else {
          var queryResult = this.where(query);
          var _queryResult2 = _slicedToArray(queryResult, 1),
            record = _queryResult2[0];
          if (record) {
            return record;
          } else {
            var mergedAttributes = Object.assign(attributesForCreate, query);
      ...
      value: function update(target, attrs) {
        ...
        if (typeof attrs === "undefined") {
          ...
          this._records.forEach(function (record) {
            ...
            _this4._updateRecord(record, attrs);
            if (!isEqual$1(oldRecord, record)) {
              changedRecords.push(record);
            }
          });
          return maybeAsync(this._async, changedRecords);
        } else if (typeof target === "number" || typeof target === "string") {
          var id = target;
          var record = this._findRecord(id);
          this._updateRecord(record, attrs);
          return maybeAsync(this._async, record);
      ...
      value: function remove(target) {
        ...
        if (typeof target === "undefined") {
          ...
          records.forEach(function (record) {
            var index = _this5._records.indexOf(record);
            _this5._records.splice(index, 1);
          });
        } else if (_typeof(target) === "object") {
        ...
        // In async mode, return a resolved Promise
        return maybeAsync(this._async, undefined);
      }
      ...
      value: function _findRecordsWhere(query) {
        ...
        if (isAsync) {
          ...
          return Promise.all(records.map(function (record) {
            ...
            return records.filter(function (_, i) {
              return results[i];
            });
          });
        }
  ...
  var Db = /*#__PURE__*/function () {
    function Db(initialData, identityManagers) {
      ...
      this._collections = [];
      this._async = false; // Will be set by container
    ...
    return _createClass(Db, [{
      ...
      value: function createCollection(name, initialData) {
        if (!this[name]) {
          var _ref, _this$_container$asyn, _this$_container;
          var _IdentityManager = this.identityManagerFor(name);
          var newCollection = new DbCollection(name, initialData, _IdentityManager);

          // Set async mode on the collection
          newCollection._async = (_ref = (_this$_container$asyn = (_this$_container = this._container) === null || _this$_container === void 0 ? void 0 : _this$_container.async) !== null && _this$_container$asyn !== void 0 ? _this$_container$asyn : this._async) !== null && _ref !== void 0 ? _ref : false;
          ...
          Object.defineProperty(this, name, {
            get: function get() {
              // In async mode, return an object with methods (not an array copy)
              if (newCollection._async) {
                return {
                  insert: function insert() {
                    return newCollection.insert.apply(newCollection, arguments);
                  },
                  find: function find() {
                    return newCollection.find.apply(newCollection, arguments);
                  },
                  findBy: function findBy() {
                    return newCollection.findBy.apply(newCollection, arguments);
                  },
                  where: function where() {
                    return newCollection.where.apply(newCollection, arguments);
                  },
                  update: function update() {
                    return newCollection.update.apply(newCollection, arguments);
                  },
                  remove: function remove() {
                    return newCollection.remove.apply(newCollection, arguments);
                  },
                  firstOrCreate: function firstOrCreate() {
                    return newCollection.firstOrCreate.apply(newCollection, arguments);
                  },
                  all: function all() {
                    return newCollection.all.apply(newCollection, arguments);
                  }
                };
              }

              // In sync mode, return array copy with methods (current behavior)
    ...
    return _createClass(Collection, [{
      ...
      */
      ...
      value: function filter(f) {
        ...
        if (isAsync) {
          // Async filter: map all promises and filter based on results
          return Promise.all(this.models.map(function (model, i) {
            return f(model, i, _this.models);
          })).then(function (results) {
            var filteredModels = _this.models.filter(function (_, i) {
              return results[i];
            });
            return new Collection(_this.modelName, filteredModels);
          });
        }
      ...
      value: function sort(f) {
        ...
        if (isAsync) {
          ...
          return this._asyncSort(f).then(function (sortedModels) {
            return new Collection(_this2.modelName, sortedModels);
          });
        }
      ...
      key: "_asyncSort",
      value: (function () {
        var _asyncSort2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(compareFn) {
          var merge, _mergeSort;
          return _regenerator().w(function (_context3) {
            while (1) switch (_context3.n) {
              case 0:
                ...
                return _context3.a(2, this.models.concat());
              case 1:
                merge = /*#__PURE__*/function () {
                  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(left, right) {
                    var result, i, j, comparison;
                    return _regenerator().w(function (_context) {
                      while (1) switch (_context.n) {
                        case 0:
                          result = [];
                        ...
                        case 1:
                          ...
                          _context.n = 2;
                          return compareFn(left[i], right[j]);
                        case 2:
                          comparison = _context.v;
                          if (comparison <= 0) {
                            result.push(left[i++]);
                          } else {
                            result.push(right[j++]);
                          ...
                          break;
                        case 3:
                          return _context.a(2, result.concat(left.slice(i)).concat(right.slice(j)));
                      }
                    }, _callee);
                  }));
                  return function merge(_x2, _x3) {
                    return _ref.apply(this, arguments);
                  };
                }();
                _mergeSort = /*#__PURE__*/function () {
                  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(arr) {
                    var mid, left, right;
                    return _regenerator().w(function (_context2) {
                      while (1) switch (_context2.n) {
                        ...
                        case 1:
                          ...
                          _context2.n = 2;
                          return _mergeSort(arr.slice(0, mid));
                        case 2:
                          left = _context2.v;
                          _context2.n = 3;
                          return _mergeSort(arr.slice(mid));
                        case 3:
                          right = _context2.v;
                          _context2.n = 4;
                  ...
                  return function mergeSort(_x4) {
                    return _ref2.apply(this, arguments);
                  };
                }();
                return _context3.a(2, _mergeSort(this.models.concat()));
            }
          }, _callee3, this);
        }));
        function _asyncSort(_x) {
          return _asyncSort2.apply(this, arguments);
        }
        return _asyncSort;
      }()
      /**
    ...
    return _createClass(RouteHandler, [{
      ...
      value: function handleWithMiddleware(request, middleware) {
        ...
        var _middleware = _toArray(middleware),
          ...
          remaining = _arrayLikeToArray(_middleware).slice(1);
    ...
    */
    ...
    return _createClass(Model, [{
        ...
        var _saveAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(collection) {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              ...
              case 4:
                _context.n = 5;
                return this._saveAssociationsAsync();
              case 5:
                this._schema.isSaving[this.toString()] = false;
      ...
      value: function update(key, val) {
        ...
        var hasPromises = Object.keys(attrs).some(function (attr) {
          return attrs[attr] instanceof Promise;
        });
        if (hasPromises) {
      ...
      value: function _implicitInverseFor(association) {
        ...
        return values$1(associations).filter(function (candidate) {
          ...
          if (candidateMatches) {
            ...
            assert(!inverse, "The ".concat(_this3.modelName, " model has multiple possible inverse associations for the ").concat(association.ownerModelName, ".").concat(association.name, " association."));
            inverse = candidate;
          }
          return inverse;
        }, null);
      ...
      */
      ...
      value: function disassociate(model, association) {
        ...
        if (association instanceof HasMany) {
          var i;
          if (association.isPolymorphic) {
            var found = this[fk].find(function (_ref2) {
              var type = _ref2.type,
                id = _ref2.id;
      ...
      */
      ...
      value: function _validateForeignKeyExistsInDatabase(foreignKeyName, foreignKeys) {
        ...
        if (Array.isArray(foreignKeys)) {
          ...
          var found;
          if (association.isPolymorphic) {
            found = foreignKeys.map(function (_ref3) {
              var type = _ref3.type,
                id = _ref3.id;
              return _this4._schema.db[_this4._schema.toInternalCollectionName(type)].find(id);
            });
      ...
      key: "_saveAssociationsAsync",
      value: function () {
        var _saveAssociationsAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
          return _regenerator().w(function (_context4) {
            while (1) switch (_context4.n) {
              case 0:
                _context4.n = 1;
                return this._saveBelongsToAssociationsAsync();
              case 1:
                _context4.n = 2;
                return this._saveHasManyAssociationsAsync();
              case 2:
                return _context4.a(2);
            }
          }, _callee4, this);
        }));
        function _saveAssociationsAsync() {
          return _saveAssociationsAsync2.apply(this, arguments);
        }
        return _saveAssociationsAsync;
      }()
    }, {
      ...
      key: "_saveBelongsToAssociationsAsync",
      value: function () {
        var _saveBelongsToAssociationsAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
          var _iterator, _step, association, _t;
          return _regenerator().w(function (_context5) {
            while (1) switch (_context5.p = _context5.n) {
              case 0:
                _iterator = _createForOfIteratorHelper(values$1(this.belongsToAssociations));
                _context5.p = 1;
                _iterator.s();
              case 2:
                if ((_step = _iterator.n()).done) {
                ...
                _context5.n = 3;
                return this._disassociateFromOldInversesAsync(association);
              case 3:
                _context5.n = 4;
                return this._saveNewAssociatesAsync(association);
              case 4:
                _context5.n = 5;
                return this._associateWithNewInversesAsync(association);
              case 5:
                _context5.n = 2;
                break;
              case 6:
          ...
          }, _callee5, this, [[1, 7, 8, 9]]);
        }));
        function _saveBelongsToAssociationsAsync() {
          return _saveBelongsToAssociationsAsync2.apply(this, arguments);
        }
        return _saveBelongsToAssociationsAsync;
      }()
    }, {
      ...
      key: "_saveHasManyAssociationsAsync",
      value: function () {
        var _saveHasManyAssociationsAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
          var _iterator2, _step2, association, _t2;
          return _regenerator().w(function (_context6) {
            while (1) switch (_context6.p = _context6.n) {
              case 0:
                _iterator2 = _createForOfIteratorHelper(values$1(this.hasManyAssociations));
                _context6.p = 1;
                _iterator2.s();
              case 2:
                if ((_step2 = _iterator2.n()).done) {
          ...
          }, _callee6, this, [[1, 7, 8, 9]]);
        }));
        function _saveHasManyAssociationsAsync() {
          return _saveHasManyAssociationsAsync2.apply(this, arguments);
        }
        return _saveHasManyAssociationsAsync;
      }()
    }, {
      ...
      key: "_disassociateFromOldInversesAsync",
      value: function () {
        var _disassociateFromOldInversesAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(association) {
          return _regenerator().w(function (_context7) {
            while (1) switch (_context7.n) {
              case 0:
                ...
                _context7.n = 1;
                return this._disassociateFromHasManyInversesAsync(association);
              case 1:
                _context7.n = 3;
                break;
              case 2:
                ...
                _context7.n = 3;
                return this._disassociateFromBelongsToInverseAsync(association);
              case 3:
                return _context7.a(2);
            }
          }, _callee7, this);
        }));
        function _disassociateFromOldInversesAsync(_x2) {
          return _disassociateFromOldInversesAsync2.apply(this, arguments);
        }
        return _disassociateFromOldInversesAsync;
      ...
      value: function _disassociateFromHasManyInverses(association) {
        ...
        if (tempAssociation && associateIds) {
          var models;
          if (association.isPolymorphic) {
            models = associateIds.map(function (_ref4) {
              var type = _ref4.type,
                id = _ref4.id;
              return _this7._schema[_this7._schema.toCollectionName(type)].find(id);
            });
          } else {
      ...
      key: "_disassociateFromHasManyInversesAsync",
      value: function () {
        var _disassociateFromHasManyInversesAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(association) {
          var _this8 = this;
          var fk, tempAssociation, associateIds, models, collection, filteredModels, _iterator3, _step3, associate, inverse, _t3;
          return _regenerator().w(function (_context9) {
            while (1) switch (_context9.p = _context9.n) {
              case 0:
                fk = association.getForeignKey();
                tempAssociation = this._tempAssociations && this._tempAssociations[association.name];
                associateIds = this.attrs[fk];
                if (!(tempAssociation && associateIds)) {
                  _context9.n = 11;
                  break;
                }
                ...
                _context9.n = 1;
                return Promise.all(associateIds.map(/*#__PURE__*/function () {
                  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(_ref5) {
                    var type, id;
              ...
              case 2:
                _context9.n = 3;
                return this._schema[this._schema.toCollectionName(association.modelName)].find(associateIds || []);
              case 3:
                collection = _context9.v;
                models = collection.models;
              case 4:
                filteredModels = models.filter(function (associate) {
                  return (
                    // filter out models that are already being saved
                    !associate.isSaving &&
                    // filter out models that will still be associated
                ...
                _iterator3 = _createForOfIteratorHelper(filteredModels);
                _context9.p = 5;
                _iterator3.s();
              case 6:
                ...
                associate = _step3.value;
                inverse = associate.inverseFor(association);
          ...
          }, _callee9, this, [[5, 9, 10, 11]]);
        }));
        function _disassociateFromHasManyInversesAsync(_x3) {
          return _disassociateFromHasManyInversesAsync2.apply(this, arguments);
        }
        return _disassociateFromHasManyInversesAsync;
      }()
      /*
        Disassociate currently persisted models that are no longer associated.
         Example:
      ...
      */
      ...
      key: "_disassociateFromBelongsToInverseAsync",
      value: function () {
        var _disassociateFromBelongsToInverseAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(association) {
          var fk, tempAssociation, associateId, associate, inverse;
          return _regenerator().w(function (_context0) {
            while (1) switch (_context0.n) {
              case 0:
                fk = association.getForeignKey();
                tempAssociation = this._tempAssociations && this._tempAssociations[association.name];
                associateId = this.attrs[fk];
                if (!(tempAssociation !== undefined && associateId)) {
                  _context0.n = 5;
                  break;
                }
                ...
                _context0.n = 1;
                return this._schema[this._schema.toCollectionName(associateId.type)].find(associateId.id);
              case 1:
                associate = _context0.v;
                _context0.n = 4;
                break;
              case 2:
                _context0.n = 3;
                return this._schema[this._schema.toCollectionName(association.modelName)].find(associateId);
              case 3:
                associate = _context0.v;
              case 4:
                if (!associate.hasInverseFor(association)) {
                ...
                associate.disassociate(this, inverse);
                _context0.n = 5;
                return associate._updateInDbAsync(associate.attrs);
              case 5:
                return _context0.a(2);
            }
          }, _callee0, this);
        }));
        function _disassociateFromBelongsToInverseAsync(_x5) {
          return _disassociateFromBelongsToInverseAsync2.apply(this, arguments);
        }
        return _disassociateFromBelongsToInverseAsync;
      ...
      key: "_saveNewAssociatesAsync",
      value: function () {
        var _saveNewAssociatesAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1(association) {
          var fk, tempAssociate, modelsToSave, _iterator4, _step4, child, _modelsToSave, _iterator5, _step5, _child, fkValue, _t4, _t5;
          return _regenerator().w(function (_context1) {
            while (1) switch (_context1.p = _context1.n) {
              case 0:
                fk = association.getForeignKey();
                tempAssociate = this._tempAssociations && this._tempAssociations[association.name];
                if (!(tempAssociate !== undefined)) {
                  _context1.n = 25;
                  break;
                }
                ...
                modelsToSave = tempAssociate.models.filter(function (model) {
                  return !model.isSaving;
                });
                _iterator4 = _createForOfIteratorHelper(modelsToSave);
                _context1.p = 1;
                _iterator4.s();
              case 2:
              ...
              case 7:
                _context1.n = 8;
                return this._updateInDbAsync(_defineProperty$1({}, fk, tempAssociate.models.map(function (child) {
                  return child.id;
                })));
              case 8:
                _context1.n = 24;
                break;
              case 9:
                if (!(tempAssociate instanceof PolymorphicCollection)) {
                  _context1.n = 18;
                  break;
                }
                _modelsToSave = tempAssociate.models.filter(function (model) {
                  return !model.isSaving;
                });
                _iterator5 = _createForOfIteratorHelper(_modelsToSave);
                _context1.p = 10;
                _iterator5.s();
              case 11:
              ...
              case 18:
                ...
                _context1.n = 19;
                return this._updateInDbAsync(_defineProperty$1({}, fk, null));
              case 19:
                _context1.n = 24;
                break;
              case 20:
                if (!this.equals(tempAssociate)) {
                  _context1.n = 22;
                  break;
                }
                _context1.n = 21;
                return this._updateInDbAsync(_defineProperty$1({}, fk, this.id));
              case 21:
                _context1.n = 24;
                break;
              case 22:
              ...
              case 23:
                ...
                _context1.n = 24;
                return this._updateInDbAsync(_defineProperty$1({}, fk, fkValue));
              case 24:
                this.__isSavingNewChildren = false;
              case 25:
                return _context1.a(2);
            }
          }, _callee1, this, [[10, 14, 15, 16], [1, 5, 6, 7]]);
        }));
        function _saveNewAssociatesAsync(_x6) {
          return _saveNewAssociatesAsync2.apply(this, arguments);
        }
        return _saveNewAssociatesAsync;
      }()
      /*
      ...
      */
        ...
        if (!this.__isSavingNewChildren) {
          ...
          if (modelOrCollection instanceof Model) {
            ...
            modelOrCollection.models.forEach(function (model) {
              _this0._associateModelWithInverse(model, association);
            });
          }
          delete this._tempAssociations[association.name];
        }
      ...
      key: "_associateWithNewInversesAsync",
      value: function () {
        var _associateWithNewInversesAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10(association) {
          var modelOrCollection, _iterator6, _step6, model, _t6;
          return _regenerator().w(function (_context10) {
            while (1) switch (_context10.p = _context10.n) {
              ...
              case 1:
                modelOrCollection = _context10.v;
                if (!(modelOrCollection instanceof Model)) {
                  _context10.n = 3;
                  break;
                }
                _context10.n = 2;
                return this._associateModelWithInverseAsync(modelOrCollection, association);
              case 2:
                _context10.n = 10;
                break;
              case 3:
                if (!(modelOrCollection instanceof Collection || modelOrCollection instanceof PolymorphicCollection)) {
                  _context10.n = 10;
                  break;
                }
                _iterator6 = _createForOfIteratorHelper(modelOrCollection.models);
                _context10.p = 4;
                _iterator6.s();
              case 5:
                ...
                model = _step6.value;
                _context10.n = 6;
                return this._associateModelWithInverseAsync(model, association);
              case 6:
                _context10.n = 5;
                break;
              case 7:
          ...
          }, _callee10, this, [[4, 8, 9, 10]]);
        }));
        function _associateWithNewInversesAsync(_x7) {
          return _associateWithNewInversesAsync2.apply(this, arguments);
        }
        return _associateWithNewInversesAsync;
      }()
    }, {
          ...
          if (inverse instanceof BelongsTo) {
            ...
            if (inverse.isPolymorphic) {
              ...
              alreadyAssociatedWith = newIdsForInverse.some(function (key) {
                return key.type == _this1.modelName && key.id == ownerId;
              });
            } else {
              _newId = ownerId;
      ...
      key: "_associateModelWithInverseAsync",
      value: function () {
        var _associateModelWithInverseAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(model, association) {
          var _this10 = this;
          var inverse, inverseFk, ownerId, newId, inverseCollection, record, currentIdsForInverse, newIdsForInverse, _newId2, alreadyAssociatedWith;
          return _regenerator().w(function (_context11) {
            while (1) switch (_context11.n) {
              case 0:
                ...
                inverse = model.inverseFor(association);
                inverseFk = inverse.getForeignKey();
                ownerId = this.id;
                if (!(inverse instanceof BelongsTo)) {
                  _context11.n = 2;
                  break;
                ...
                _context11.n = 1;
                return this._schema.db[this._schema.toInternalCollectionName(model.modelName)].update(model.id, _defineProperty$1({}, inverseFk, newId));
              case 1:
                _context11.n = 4;
                break;
              case 2:
                inverseCollection = this._schema.db[this._schema.toInternalCollectionName(model.modelName)];
                _context11.n = 3;
                return inverseCollection.find(model.id);
              case 3:
                record = _context11.v;
                currentIdsForInverse = record[inverse.getForeignKey()] || [];
                newIdsForInverse = Object.assign([], currentIdsForInverse);
                if (inverse.isPolymorphic) {
                  _newId2 = {
                    type: this.modelName,
                    id: ownerId
                  ...
                  alreadyAssociatedWith = newIdsForInverse.some(function (key) {
                    return key.type == _this10.modelName && key.id == ownerId;
                  });
                } else {
                  _newId2 = ownerId;
                  alreadyAssociatedWith = newIdsForInverse.includes(ownerId);
                ...
                _context11.n = 4;
                return inverseCollection.update(model.id, _defineProperty$1({}, inverseFk, newIdsForInverse));
              case 4:
                return _context11.a(2);
            }
          }, _callee11, this);
        }));
        function _associateModelWithInverseAsync(_x8, _x9) {
          return _associateModelWithInverseAsync2.apply(this, arguments);
        }
        return _associateModelWithInverseAsync;
      ...
      key: "_updateInDbAsync",
      value: function () {
        var _updateInDbAsync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12(attrs) {
          return _regenerator().w(function (_context12) {
            while (1) switch (_context12.n) {
              case 0:
                _context12.n = 1;
                return this._schema.db[this._schema.toInternalCollectionName(this.modelName)].update(this.attrs.id, attrs);
              case 1:
                this.attrs = _context12.v;
              case 2:
                return _context12.a(2);
            }
          }, _callee12, this);
        }));
        function _updateInDbAsync(_x0) {
          return _updateInDbAsync2.apply(this, arguments);
        }
        return _updateInDbAsync;
      }()
      /*
      ...
      */
      ...
      value: function _syncTempAssociations(tempAssociate) {
        ...
        Object.keys(this._tempAssociations).forEach(function (key) {
          if (_this11._tempAssociations[key] && _this11._tempAssociations[key].toString() === tempAssociate.toString()) {
            _this11._tempAssociations[key] = tempAssociate;
          }
        });
      }
  ...
  */
  ...
  var Schema = /*#__PURE__*/function () {
    ...
    return _createClass(Schema, [{
      key: "_isAsync",
      get: function get() {
        var _this$_container$asyn, _this$_container;
        return (_this$_container$asyn = (_this$_container = this._container) === null || _this$_container === void 0 ? void 0 : _this$_container.async) !== null && _this$_container$asyn !== void 0 ? _this$_container$asyn : false;
      }
      ...
      value: function all(type) {
        ...
        if (this._isAsync) {
          // In async mode, collection is an object with methods, not an array
          var records = collection.all();
          return records.then(function (r) {
            return _this3._hydrate(r, dasherize(type));
          });
        }

        // In sync mode, collection is an array with methods
      ...
      value: function find(type, ids) {
        ...
        if (this._isAsync) {
          return records.then(function (r) {
            if (Array.isArray(ids)) {
              assert(r.length === ids.length, "Couldn't find all ".concat(_this4._container.inflector.pluralize(type), " with ids: (").concat(ids.join(","), ") (found ").concat(r.length, " results, but was looking for ").concat(ids.length, ")"));
            }
            return _this4._hydrate(r, dasherize(type));
          });
        }
        if (Array.isArray(ids)) {
      ...
      value: function findBy(type, query) {
        ...
        if (this._isAsync) {
          return record.then(function (r) {
            return _this5._hydrate(r, dasherize(type));
          });
        }
      ...
      value: function findOrCreateBy(type, attrs) {
        ...
        if (this._isAsync) {
          return record.then(function (r) {
            if (!r) {
              return _this6.create(type, attrs);
            } else {
              return _this6._hydrate(r, dasherize(type));
            }
          });
        }
        var model;
      ...
      value: function where(type, query) {
        ...
        if (records && typeof records.then === 'function') {
          return records.then(function (r) {
            return _this7._hydrate(r, dasherize(type));
          });
        }
        if (this._isAsync) {
          return records.then(function (r) {
      ...
      value: function first(type) {
        ...
        var collection = this.collectionForType(type);
        if (this._isAsync) {
          return collection.all().then(function (records) {
            var record = records[0];
            return _this8._hydrate(record, dasherize(type));
          });
        }
  ...
  */
  ...
  var Pretender = typeof Pretender$1 === 'function' && Pretender$1 || typeof ((_PretenderModule$defa = Pretender$1) === null || _PretenderModule$defa === void 0 ? void 0 : _PretenderModule$defa.default) === 'function' && Pretender$1.default || typeof PretenderModule === 'function' && PretenderModule || Pretender$1 || PretenderModule;
  ...
  var Server = /*#__PURE__*/function () {
    ...
    return _createClass(Server, [{
      ...
      value: function config() {
        ...
        /**
          Set to `true` to enable async mode, where all database operations return Promises.
          This is opt-in for backward compatibility and to prepare for storage adapter support.
           By default, async mode is disabled and operations return values directly.
           ```js
          createServer({
            async: true,
            routes() {
          ...
          @public
        */
        this.async = _config.async !== undefined ? _config.async : false;
        this._container.register("async", this.async);
      ...
      */
      ...
      key: "build",
      value: function () {
        var _build = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(type) {
          var _len3,
            traitsAndOverrides,
            _key3,
            traits,
          ...
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.n) {
              case 0:
                for (_len3 = _args2.length, traitsAndOverrides = new Array(_len3 > 1 ? _len3 - 1 : 0), _key3 = 1; _key3 < _len3; _key3++) {
                  traitsAndOverrides[_key3 - 1] = _args2[_key3];
                }
                traits = traitsAndOverrides.filter(function (arg) {
                  return arg && typeof arg === "string";
                });
                overrides = find$1(traitsAndOverrides, function (arg) {
                  return isPlainObject$1(arg);
                });
                camelizedType = camelize(type); // Store sequence for factory type as instance variable
                ...
                attrs = OriginalFactory.attrs || {};
                this._validateTraits(traits, OriginalFactory, type);
                mergedExtensions = this._mergeExtensions(attrs, traits, overrides);
                _context2.n = 1;
                return this._mapAssociationsFromAttributes(type, attrs, overrides);
              case 1:
                _context2.n = 2;
                return this._mapAssociationsFromAttributes(type, mergedExtensions);
              case 2:
                Factory = OriginalFactory.extend(mergedExtensions);
                factory = new Factory();
                sequence = this.factorySequences[camelizedType];
                _context2.n = 3;
                return factory.build(sequence);
              case 3:
                return _context2.a(2, _context2.v);
              case 4:
                return _context2.a(2, overrides);
              case 5:
                return _context2.a(2);
            }
          }, _callee2, this);
      ...
      key: "buildList",
      value: function () {
        var _buildList = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(type, amount) {
          var list,
            _len4,
            traitsAndOverrides,
            _key4,
          ...
          return _regenerator().w(function (_context3) {
            while (1) switch (_context3.n) {
              case 0:
                ...
                list = [];
                for (_len4 = _args3.length, traitsAndOverrides = new Array(_len4 > 2 ? _len4 - 2 : 0), _key4 = 2; _key4 < _len4; _key4++) {
                  traitsAndOverrides[_key4 - 2] = _args3[_key4];
                }
                buildArgs = [type].concat(traitsAndOverrides);
                i = 0;
              case 1:
                if (!(i < amount)) {
                  _context3.n = 4;
                ...
                _t = list;
                _context3.n = 2;
                return this.build.apply(this, buildArgs);
              case 2:
                _t.push.call(_t, _context3.v);
              case 3:
                i++;
                _context3.n = 1;
                break;
              case 4:
                return _context3.a(2, list);
            }
          }, _callee3, this);
        }));
        function buildList(_x2, _x3) {
      ...
      */
      ...
      key: "create",
      value: (function () {
        var _create = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(type) {
          var _len5,
            options,
            _key5,
            traits,
          ...
          return _regenerator().w(function (_context4) {
            while (1) switch (_context4.p = _context4.n) {
              case 0:
                ...
                for (_len5 = _args4.length, options = new Array(_len5 > 1 ? _len5 - 1 : 0), _key5 = 1; _key5 < _len5; _key5++) {
                  options[_key5 - 1] = _args4[_key5];
                }
                traits = options.filter(function (arg) {
                  return arg && typeof arg === "string";
                });
                overrides = find$1(options, function (arg) {
                  return isPlainObject$1(arg);
                });
                collectionFromCreateList = find$1(options, function (arg) {
      ...
      */
      ...
      key: "createList",
      value: (function () {
        var _createList = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(type, amount) {
          var list,
            collectionName,
            collection,
            _len6,
          ...
          return _regenerator().w(function (_context5) {
            while (1) switch (_context5.n) {
              case 0:
                ...
                collectionName = this.schema ? this.schema.toInternalCollectionName(type) : "_".concat(this.inflector.pluralize(type));
                collection = this.db[collectionName];
                for (_len6 = _args5.length, traitsAndOverrides = new Array(_len6 > 2 ? _len6 - 2 : 0), _key6 = 2; _key6 < _len6; _key6++) {
                  traitsAndOverrides[_key6 - 2] = _args5[_key6];
                }
                createArguments = [type].concat(traitsAndOverrides, [collection]);
                i = 0;
              case 1:
                if (!(i < amount)) {
                  _context5.n = 4;
                ...
                _t3 = list;
                _context5.n = 2;
                return this.create.apply(this, createArguments);
              case 2:
                _t3.push.call(_t3, _context5.v);
              case 3:
                i++;
                _context5.n = 1;
                break;
      ...
      */
      ...
      value: function resource(resourceName) {
        ...
        actions.forEach(function (action) {
          ...
          methodsWithPath.methods.forEach(function (method) {
            return path === resourceName ? _this2[method](methodsWithPath.path) : _this2[method](methodsWithPath.path, resourceName);
          });
        });
      }
    }, {
      ...
      value: function registerRouteHandler(verb, path, rawHandler, customizedCode, options) {
        ...
        return function (request) {
          return routeHandler.handle(request).then(function (mirageResponse) {
            ...
            return [code, headers, _this3._serialize(response)];
          });
        };
      }
      ...
      value: (function () {
        var _mapAssociationsFromAttributes2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(modelName, attributes) {
          var overrides,
            associationAttrs,
            _iterator2,
            _step2,
          ...
          return _regenerator().w(function (_context6) {
            while (1) switch (_context6.p = _context6.n) {
              case 0:
                ...
                return _context6.a(2);
              case 1:
                associationAttrs = Object.keys(attributes || {}).filter(function (attr) {
                  return isAssociation(attributes[attr]);
                });
                _iterator2 = _createForOfIteratorHelper(associationAttrs);
                _context6.p = 2;
                _iterator2.s();
              case 3:
                if ((_step2 = _iterator2.n()).done) {
                ...
                attr = _step2.value;
                modelClass = this.schema.modelClassFor(modelName);
                association = modelClass.associationFor(attr);
                ...
                isSelfReferentialBelongsTo = association && association instanceof BelongsTo && association.modelName === modelName;
                ...
                isPolymorphic = association && association.opts && association.opts.polymorphic;
                ...
                factoryAssociation = attributes[attr];
                foreignKey = "".concat(camelize(attr), "Id");
                if (overrides[attr]) {
                  _context6.n = 5;
                  break;
                }
                _context6.n = 4;
                return this.create.apply(this, [association.modelName].concat(_toConsumableArray(factoryAssociation.traitsAndOverrides)));
              case 4:
                created = _context6.v;
          ...
          }, _callee6, this, [[2, 8, 9, 10]]);
        }));
        function _mapAssociationsFromAttributes(_x7, _x8) {
          return _mapAssociationsFromAttributes2.apply(this, arguments);
        }
        return _mapAssociationsFromAttributes;
      }())
    }]);
  }();
